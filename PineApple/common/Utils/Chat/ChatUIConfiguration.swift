...
class ChatUIConfiguration: ATCUIGenericConfigurationProtocol {
    ...
    let mainThemeForegroundColor: UIColor = UIColor(hex: 0x3068CC)
    let mainTextColor: UIColor = UIColor(hex: 0x000000)
    let mainSubtextColor: UIColor = UIColor(hex: 0x7e7e7e)
    let statusBarStyle: UIStatusBarStyle = .default
    let hairlineColor: UIColor = UIColor(hex: 0xd6d6d6)
